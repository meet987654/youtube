...
const commentsData = [
  {
    name: "Meet Prajpati",
    text: "This is such an amazing video",
    replies: [],
  },
  {
    name: "Meet Prajpati",
...
const Comment = ({ data }) => {
  ...
  return (
    <div className="flex shadow-sm bg-gray-100 rounded-lg p-2 m-2">
      <img
      ...
      {comments.map((comment, index) => (
        <div key={index}>
          ...
          {comment.replies.length > 0 && (
            <div className='pl-7 border-l border-gray-300 ml-5'>
